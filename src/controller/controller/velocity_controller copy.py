...
class VelocityController(Node):
    ...
    def __init__(self):
        ...
        self.sub_odom_ = self.create_subscription(PoseWithCovarianceStamped, '/amcl_pose', self.pose_callback, 10)
    ...
    def publish_velocity(self):
        ...
        twist = Twist()
        twist.linear.x = max(min(a, 0.5), -0.5)  # Limit linear velocity
